...
class initErrorDialog(QDialog):
    ...
    def initUI(self):
        ...
        self.warningText = QLabel('Error: CivilTools requires that the project be set to a projected coordinate system. Please change the project CRS before continuing.')
