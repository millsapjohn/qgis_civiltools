from PyQt5.QtWidgets import QDialog, QPushButton, QLabel, QVBoxLayout, QHBoxLayout, QFileDialog, QLineEdit
...
class initDialog(QDialog):
    ...
    def getSaveFile(self):
        ...
        self.filename = self.filenameDialog.getSaveFileName(self, 'Specify Save Location:', self.homePath, 'GeoPackage (*.gpkg)')[0]
